        ...
        <div class="row">
          ...
          <div class="d-flex">
            ...
            <select name="qty" id="qty">
                ...
                <div>
                <button type="button" class="btn btn-dark mt-2 btns">Subscribed</button>
                </div>

            </div>
            <div class="col sm-5 md-5">
            <button type="button" class=" my-3  btns bg-white p-1 rounded w-100">Deliverey Details</button>
            {/* <button type="button" class=" my-3 btns bg-white p-1 w-100">Write a Product Review</button> */}
